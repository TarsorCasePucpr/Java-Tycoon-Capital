...
public class HockeyTeam extends ItemMenu {
    ...
    public boolean HockeyTeamManager = false;

    //Construtor CarWash reutiliza o construtor do ItemMenu
    public HockeyTeam(int preco_compra,int quantidade,int lucro,int velocidade_producao,int tempo_producao){
